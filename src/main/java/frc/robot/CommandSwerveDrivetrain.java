...
public class CommandSwerveDrivetrain extends
	...
	private final PIDController autoXPid = new PIDController(AutoConstants.CHOREO_X_P, 0, 0); //17.5
	private final PIDController autoYPid = new PIDController(AutoConstants.CHOREO_Y_P, 0, 0); //17.5
	private final PIDController autoHeadingPid =
		new PIDController(AutoConstants.CHOREO_HEADING_P, 0, 0); // 0.8
	...
	public CommandSwerveDrivetrain(
		...
		autoXPid.setTolerance(AutoConstants.CHOREO_PID_TOLERANCE);
		autoYPid.setTolerance(AutoConstants.CHOREO_PID_TOLERANCE);
		// setupPathplanner();
	}
