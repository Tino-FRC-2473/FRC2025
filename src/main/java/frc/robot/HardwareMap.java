...
public final class HardwareMap {
	...
	public static final int ELEVATOR_LIMIT_SWITCH_PORT = 0; // not confirmed with electrical
	public static final int CLIMBER_LIMIT_SWITCH_PORT = 0; // not confirmed with electrical
