...
public class VisionConstants {
	...
	public static final double MAX_ANGULAR_SPEED_RADIANS_PER_SECOND = Math.PI / 24;

	public static final double TRANSLATIONAL_ACCEL_CONSTANT = 1;
	public static final double ROTATIONAL_ACCEL_CONSTANT = 0.7;
	//TODO: equate the margin to the probabilistic equation from HW.
	public static final double X_MARGIN_TO_REEF = 0.5;
	public static final double Y_MARGIN_TO_REEF = 0.05;
	public static final double ROT_MARGIN_TO_REEF = 0.03;
