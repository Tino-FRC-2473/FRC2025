...
/** These will be constants associated with each auto path and command in AutoRoutines. */
public class AutoConstants {
	...
	public static final double ABS_REEF_OFFSET_X_DISTANCE_METERS = Units.inchesToMeters(13) / 2;
	public static final double ABS_REEF_OFFSET_Y_DISTANCE_METERS = 0;

	//Calculated final offset constants
	public static final double REEF_OFFSET_X_AUTO_SPEED_M_S = ABS_REEF_OFFSET_X_DISTANCE_METERS / TIME_DRIVING_OFFSET;
	public static final double REEF_OFFSET_Y_AUTO_SPEED_M_S = ABS_REEF_OFFSET_Y_DISTANCE_METERS / TIME_DRIVING_OFFSET;
