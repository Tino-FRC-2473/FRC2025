...
public class AutoConstants {
	...
	public static final double ALIGN_THETA_P = 0.45;
	public static final double ALIGN_THETA_D = 0.05;
	...
	public static final double ALIGN_MAX_R_SPEED = Units.degreesToRadians(360.0) * 0.6;
