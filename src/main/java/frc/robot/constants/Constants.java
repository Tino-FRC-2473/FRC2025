...
public final class Constants {
	...
	public static final double FUNNEL_CLOSE_REAL_TIME_SECS = 0.5; // seconds
	public static final double FUNNEL_CLOSE_SIM_TIME_SECS
		= FUNNEL_CLOSE_REAL_TIME_SECS * 2; // seconds
	public static final double FUNNEL_CLOSE_TIME_SECS =
		(Utils.isSimulation()) ? FUNNEL_CLOSE_SIM_TIME_SECS : FUNNEL_CLOSE_REAL_TIME_SECS;
